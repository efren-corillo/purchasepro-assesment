...
export default defineConfig( {
  ...
  resolve: {
    alias: [
      ...
      { find: "@assets", replacement: fileURLToPath( new URL( './public/assets', import.meta.url ) ) },
      { find: "@images", replacement: fileURLToPath( new URL( './resources/images', import.meta.url ) ) },
